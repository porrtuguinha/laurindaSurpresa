...
<div className="fotos">
        ...
        <div className="fotos-coluna1">
            ...
            <div>
                <img src="images/neuGaranhão.jpg" height="500px" width="450px"></img>
            </div>
        </div>
        <div className="fotos-coluna1">
            <div className="imagemlado1">
                <img src="images/neu.jpg" height="500px" width="450px"></img>
            </div>
            <div className="imagemlado2">
                <img src="images/netos.jpg" height="500px" width="450px"></img>
            </div>
            <div>
                <img src="images/inicio.png" height="500px" width="450px"></img>
            </div>
        </div>
        <div className="fotos-coluna1">
            <div className="imagemlado1">
                <img src="images/elegancia.jpg" height="500px" width="450px"></img>
            </div>
            <div className="imagemlado2">
                <img src="images/lindinhos.jpg" height="500px" width="450px"></img>
            </div>
            <div>
                <img src="images/onsbu.jpg" height="500px" width="450px"></img>
            </div>
        </div>
        <div className="fotos-coluna1">
            <div className="imagemlado1">
                <img src="images/vóFeliz.jpg" height="500px" width="450px"></img>
            </div>
            <div className="imagemlado3">
